...
editor_options: 
  markdown: 
    wrap: 72
---
<script src="{{< blogdown/postref >}}index.fr_files/kePrint/kePrint.js"></script>
...
<img src="{{< blogdown/postref >}}index.fr_files/figure-html/unnamed-chunk-6-1.png" width="672" />
